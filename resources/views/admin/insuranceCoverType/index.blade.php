                        ...
                        @if (!$result->isEmpty())
                            @foreach ($result as $key => $record)
                                <tr>
                                    ...
                                    <td>
                                        @can('INSURANCE_COVER_TYPE_STATUS')
                                            @if ($record->status == 1)
                                    ...
                                    <td>
                                        @can('INSURANCE_COVER_TYPE_VIEW')
                                        <a title="{{ trans('View') }}" href="{{ route('admin.insuranceCoverType.view', $record->id) }}"
