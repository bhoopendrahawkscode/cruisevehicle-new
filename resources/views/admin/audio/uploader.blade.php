...
<div class="uploadWrap" id="uploadWrap" onclick="setErrorEmpty()">
    <form id="uploaderForm">
        <div class="uploadCircle uploadWrapToHide"> <em class="fa-solid fa-upload"></em><input accept="audio/mpeg" name="fileInput" id="fileInput" type="file" /></div>
        <div class="uploadText uploadWrapToHide">
            <strong>{{trans("messages.dragDropFile")}}</strong>
        </div>
        ...
        <p class="progressBar" style="display:none;color:#f00;">
            {{trans("messages.audioIsUploading")}}
        </p>
    </form>
</div>
<script>
