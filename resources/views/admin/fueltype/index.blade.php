                        ...
                        @if (!$result->isEmpty())
                            @foreach ($result as $key => $record)
                                <tr>
                                    ...
                                    <td>
                                        @can('FUEL_USED_EDIT')
                                            <a title="{{ trans('Edit') }}" href="{{route('admin.fueltype.edit',$record->id)}}" class="btn btn-primary">
                                                <em class="fa fa-pencil"></em>
                                            </a>
                                        @endcan
                                        @can('FUEL_USED_DELETE')
                                            <a class="btn btn-primary delete_any_item" data-id="{{route('admin.fueltype.delete',$record->id)}}"
