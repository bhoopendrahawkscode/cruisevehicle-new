<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label for="name">{{ trans('Fuel Used Name') }} <span class="red_lab">
                    *</span></label>
            {{ html()->text('name', null)->attributes(['class' => 'form-control', 'placeholder' => trans('Fuel Used Name'), 'enctype' => 'multipart/form-data'])->open() }}
            @if ($errors->has('name'))
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="cost">{{ trans('Fuel Cost') }} <span class="red_lab">
                    *</span></label>
            {{ html()->text('cost', null)->attributes(['class' => 'form-control', 'placeholder' => trans('Fuel cost')])->open() }}
            @if ($errors->has('cost'))
                <span class="invalid-feedback" role="alert">
