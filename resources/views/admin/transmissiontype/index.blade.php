                ...
                <div class="form_row">
                    ...
                    <div class="form-action ">
                        ...
                        <a href="{{ route($listRoute) }}" class="btn btn-sm border_btn btnIcon"
                            ...
                            @can('TRANSMISSION_TYPE_ADD')
                            <a href="{{route('admin.transmissiontype.add')}}" class="btn theme_btn bg_theme btn-sm py-2  btnIcon"
                        ...
                        @if (!$result->isEmpty())
                            @foreach ($result as $key => $record)
                                <tr>
                                    ...
                                    <td>
                                        @can('TRANSMISSION_TYPE_CHANGE_STATUS')
                                        @if ($record->status == 1)
                                    ...
                                    <td>
                                        @can('TRANSMISSION_TYPE_EDIT')
                                            <a title="{{ trans('Edit') }}" href="{{route('admin.transmissiontype.edit',$record->id)}}" class="btn btn-primary">
                                                <em class="fa fa-pencil"></em>
                                            </a>
                                        @endcan
                                        @can('TRANSMISSION_TYPE_DELETE')
                                            <a class="btn btn-primary delete_any_item" data-id="{{route('admin.transmissiontype.delete',$record->id)}}"
                                                title="{{ trans('Delete') }}" href="javascript::void(0);">
                                                <em class="fa fa-trash"></em>
                                            </a>
                                        @endcan
                                        {{-- @can('TRANSMISSION_TYPE_VIEW')
                                            <a title="{{ trans('View') }}" href="{{ route('admin.transmissiontype.view', $record->id) }}"
