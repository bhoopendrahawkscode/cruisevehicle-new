<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label for="name">{{ trans('Transmission Type Name') }} <span class="red_lab">
                    *</span></label>
            {{ html()->text('name', null)->attributes(['class' => 'form-control', 'placeholder' => trans('Transmission Type Name'), 'enctype' => 'multipart/form-data'])->open() }}
            @if ($errors->has('name'))
...
@if (env('ENABLE_CLIENT_VALIDATION'))
    <script>
        ...
        $(function() {
            ...
            window.formReference = $("#transmissiontypeForm").validate({
                rules: {
