...
@section('content')
    ...
    <div class="header d-flex align-items-center">
        <h1 class="page-header">
            {{ trans('messages.add') }} {{ trans('messages.user') }}
        </h1>
    ...
    <div id="page-inner">
        <div class="panel panel-default">
            <div class="panel-body">
                {{ html()->modelForm(null, 'POST')->route('admin.saveUser')->attributes(['id' => 'userForm', 'class' => 'form-horizontal', 'role' => 'form', 'autocomplete' => 'off'])->open() }}
                <div class="row">
                    <div class="col-md-6">
                ...
                @if (Constant::ALLOW_SUB_ADMIN_PASSWORD_CREATE)
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group clearValidation">
                                <label for="password">{{ trans('messages.password') }}<span class="red_lab">
                                        *</span></label>
                                <input class="form-control" id="password"
                                    placeholder="{{ trans('messages.enterPassword') }}" reqired="required" name="password"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group clearValidation">
                                <label for="confirm_password">{{ trans('messages.confirmPassword') }}<span class="red_lab">
                                        *</span></label>
                                <input class="form-control" id="confirm_password"
                                    placeholder="{{ trans('messages.enterConfirmPassword') }}" reqired="required"
                            ...
                            <div class="form-group clearValidation3">
                                ...
                                <div class="row gx-2 gx-md-3">
                                    <div class="col-sm-6 mb-4 mb-sm-0 errorPlacement2">
                                        {{ html()->select('country_code', $phonecode, '')->attributes([
                ...
                <div class="form-group d-flex gap-3">
                    ...
                    <a href="{{ route('admin.listSubadmin') }}" class="btn px-sm-5 font-semibold border_btn"><em
