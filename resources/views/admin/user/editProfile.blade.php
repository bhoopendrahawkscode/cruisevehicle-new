...
<section id="page-inner">
		...
		{{--<div class="form-group col-md-6 clearValidation3">
			...
			<div class="row gx-2 gx-lg-3 gy-3">
				<div class="col-lg-6 errorPlacement mb-3 mb-lg-0">
                    {{ html()->select('country_code',$phonecode,$authDetail->country_code)->attributes(['class' => 'form-control select2',
				...
				<div class="col-lg-6 w-fullInner">
                    {{ html()->text('mobile_no',$authDetail->mobile_no)->attributes(['class' => 'form-control', 'placeholder' => trans("messages.phoneNo"),'required'=>'required']) }}
				</div>
			</div>
    ...
    <div class="row">
		<div class="col-md-6">
			<div class="form-group ">
				<label for="phone">{{ 'Last updated date and time' }}</label>
				<div class="row">

					<div class="col-sm-6 mb-4 mb-sm-0 errorPlacement2">
						<span class="success"> {{ date(Config::get('constants.ADMIN_LISTING_DATE_FORMAT'), strtotime($authDetail->updated_at)) }} </span>
	...
	<div class="form-group d-flex gap-3">
		<button type="submit" class="btn theme_btn bg_theme font-semibold border-0 fs-6 px-sm-5">Update</button>
