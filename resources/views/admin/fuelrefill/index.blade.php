   ...
   // pr($result);die;
    ...
    <div class="header d-flex align-items-center">
        ...
        <ol class="breadcrumb ms-auto mb-0">
            ...
            <li class="active">Fuel Refill  {{ trans('messages.list') }}</li>
        </ol>
    </div>
    <div id="page-inner">
                ...
                <div class="form_row">
                    ...
                    <div class="form-action ">
                        ...
                        <a href="{{ route($listRoute) }}" class="btn btn-sm border_btn btnIcon"
                            ...
                            @can('FUEL_USED_ADD')
                            <a href="{{route('admin.fueltype.add')}}" class="btn theme_btn bg_theme btn-sm py-2  btnIcon"
                    ...
                    @if (!$result->isEmpty())
                        <thead>
                            ...
                            <th scope="col">
                                ...
                                @php getSortIcon($sortBy,$order,'owner_name') @endphp
                            </th>
                            <th scope="col">
                                {{ link_to_route(
                                    $listRoute,
                                ...
                                @php getSortIcon($sortBy,$order,'cost') @endphp
                            </th>
                            <th scope="col">
                                {{ link_to_route(
                                    $listRoute,
                        ...
                        @if (!$result->isEmpty())
                            @foreach ($result as $key => $record)
                                <tr>
                                    ...
                                    <td>
                                        {{ $record->fuel_refill_cost }}
                                    </td>
                                    <td>
                                        {{ $record->fuel_refill_mileage }}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        @can('FUEL_USED_DELETE')
                                            <a class="btn btn-primary delete_any_item" data-id="{{route('admin.fuelrefill.delete',$record->id)}}"
