...
<div class="header d-flex align-items-center">
    <h1 class="page-header">
        @lang('messages.add') @lang('messages.meta')
    </h1>
...
<div id="page-inner">
    <div class="panel panel-default">
        <div class="panel-body">
            {{ html()->modelForm(null, 'POST')->route('meta.tag.save')
            ->attributes(['id'=>'metaForm','autocomplete' => 'off','enctype'=>'multipart/form-data'])->open() }}
