					...
					<thead>
                        ...
                        <th scope="col" class="w-10p">
							{{
                                    link_to_route(
                                        $listRoute,
                                        trans("messages.validity_day"),
                                        array(
                                            'sortBy' => 'validity',
                                            'order' => ($sortBy == 'validity' && $order == 'desc') ? 'asc' : 'desc'
                                        ),
                                        $query_string
                                    )
								}}
							@php getSortIcon($sortBy,$order,'validity') @endphp
						</th>
                        ...
                        <th scope="col" class="w-10p">
							...
							@php getSortIcon($sortBy,$order,'price') @endphp
						</th>
