...
@section('content')
    ...
    <div class="header d-flex align-items-center">
        <h1 class="page-header">
             {{ trans('messages.insuranceQuoteReplyList') }}
        </h1>
        <ol class="breadcrumb ms-auto mb-0">
            <li><a href="{{ Route('admin.dashboard') }}"><em class="fa fa-dashboard"></em> {{ trans('messages.dashboard') }}
                </a></li>
            <li class="active"> {{ trans('messages.insuranceQuoteReplyList') }}</li>
        </ol>
    </div>
    <div id="page-inner">
                ...
                <div class="form_row">
                    <div class="form_fields d-flex mb-0 gap-2">
                        <div class="form-group mb-0">
                            {{ html()->text('request_reference_number', isset($searchVariable['request_reference_number']) ? $searchVariable['request_reference_number'] : '')->attributes(['class' => 'form-control', 'placeholder' => trans('messages.user_reference_number')]) }}
                        </div>
                        ...
                        @if (!$result->isEmpty())
                            @foreach ($result as $key => $record)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $record->comment ? Str::limit($record->comment, 20, '...') : 'Not Available' }}
                                    </td>
                                    ...
                                    <td>
                                        <a title="{{ trans('Edit') }}" href="{{ route('admin.insuranceQuoteReply.edit', $record->id) }}"
                                            class="btn btn-primary">
                                            <em class="fa fa-pencil"></em>
                                        </a>
                                        <a title="{{ trans('View') }}" href="{{ route('admin.insuranceQuoteReply.view', $record->id) }}"
                                            class="btn btn-primary">
                                            <em class="fa fa-eye"></em>
                                        </a>
                                        <a title="{{ trans('Reply') }}" href="{{ route('admin.insuranceQuoteReply.reply', $record->id) }}"
                                            class="btn btn-primary">
