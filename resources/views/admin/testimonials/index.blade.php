			...
			<div class="form_row">
				<div class="form_fields d-flex mb-0 gap-2">
					<div class="form-group mb-0">
                        ...
                        'placeholder' => trans("messages.description_giver")]) }}
					</div>
				...
				<div class="form-action ">
                    ...
                    <a href="{{url('admin/export/Testimonial/xls')}}" class="btn btn-sm border_btn" title="Export Xls">Export Xls</a>
                    <a href="{{url('admin/export/Testimonial/csv')}}" class="btn btn-sm border_btn" title="Export Csv">Export Csv</a>
				...
				<table class="@if (!$result->isEmpty()) table table-striped table-hover @endif" id="sortable">
						...
						<tr>
							...
							<th scope="col" class="w-15p">
								{{
										link_to_route(
										$listRoute,
										trans("messages.giver"),
										array(
										'sortBy' => 'giver',
										'order' => ($sortBy == 'giver' && $order == 'desc') ? 'asc' : 'desc'
										),
										$query_string
										)
									}}
								@php getSortIcon($sortBy,$order,'giver') @endphp
							</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="breakAll">
								{{ strip_tags(Str::limit($record->description, 200)) }}
							</td>
							<td class="breakAll">
								{{ $record->giver }}
							</td>
