            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="clearValidation form-group
                        ...
                        <label for=" {{ trans('messages.headline') }} {{ '(' . $languageRow->name . ')' }}">
                            {{ trans('messages.headline') }} <span class="d-none">{{ '(' . $languageRow->name . ')' }}</span>
                            <span class="red_lab"> *</span>
                        </label>
                        {{ html()->text('name[' . $languageRow->id . ']')
                            ->attributes(['class' => 'form-control languages_name formValidate',
                            'placeholder' => trans("messages.headline")]) }}
            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="clearValidation form-group
                        ...
                        {{ html()->hidden('id[' . $languageRow->id . ']') }}
                        <label for=" {{ trans('messages.description') }} {{ '(' . $languageRow->name . ')' }}">
                            {{ trans('messages.description') }} <span class="d-none">{{ '(' . $languageRow->name . ')' }}</span>
                            <span class="red_lab"> *</span>
                        </label>
                        {{ html()->textarea('description[' . $languageRow->id . ']')
