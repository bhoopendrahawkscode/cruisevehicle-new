			...
			<div class="form_row">
				<div class="form_fields d-flex mb-0 gap-2">
					<div class="form-group mb-0">
                        ...
                        'placeholder' => trans("messages.searchBy")." ".trans('messages.headline')]) }}
					</div>
				...
				<table class="@if (!$result->isEmpty()) table table-striped table-hover @endif" id="sortable">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<img class="border border-1" alt="{{$record->name}}" src="{{ $record->thumbImage }}" width="50">
							</td>
                            <td>
