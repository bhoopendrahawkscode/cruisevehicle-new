                ...
                <div class="form_row">
                    <div class="form_fields d-flex mb-0 gap-2">
                        <div class="form-group mb-0">
                            {{ html()->text('name', isset($searchVariable['name']) ? $searchVariable['name'] : '')->attributes(['class' => 'form-control', 'placeholder' => trans('Search by Model Name')]) }}
                        </div>
                    ...
                    <div class="form-action ">
                        ...
                        @can('MODEL_ADD')
                            <a href="{{ route('admin.model.add') }}" class="btn theme_btn bg_theme btn-sm py-2  btnIcon"
                        ...
                        @if (!$result->isEmpty())
                            @foreach ($result as $key => $record)
                                ...
                                @endcan
                                    ...
                                    <td>
                                        @can('MODEL_EDIT')
                                            <a title="{{ trans('Edit') }}" href="{{ route('admin.model.edit', $record->id) }}"
                                        ...
                                        @can('MODEL_DELETE')
                                            <a class="btn btn-primary delete_any_item"
                                                data-id="{{ route('admin.model.delete', $record->id) }}"
