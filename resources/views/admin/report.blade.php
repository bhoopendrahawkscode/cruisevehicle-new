...
@section('content')
    ...
    <div class="header d-flex align-items-center">
        <h1 class="page-header">
            {{ trans('messages.ReportManager') }}
        </h1>
        <ol class="breadcrumb ms-auto mb-0">
            <li><a href="javascript:void(0);"><em class="fa fa-dashboard"></em> {{ trans('messages.ReportManager') }}</a></li>
        </ol>
    </div>
    @can('REPORT_LIST')
    <section id="page-inner" class="admin-dashboard">
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-body form_fields">
                        {{ html()->modelForm(null, 'GET')->route('admin.report')->attributes([
                        ...
                        <a href="{{ Route('admin.report') }}" title="{{ trans('messages.reset') }}"
        ...
        <div class="row gx-3">
            <div class="col-xl-4 col-sm-12 col-xs-12 col-md-6">
                <div class="board">
                    <div class="panel panel-primary">
                        <a href="{{ route('admin.serviceprovider.list') }}?<?php echo appendDate(); ?>">
                            <div class="number">
                                <h3>
                                    <h3>{{ isset($totalServiceProvider) ? $totalServiceProvider : '' }}</h3>
                                    <small>{{ trans('messages.no_service_provider') }}</small>
                                </h3>
                            </div>
                            <div class="icon">
                ...
                <div class="board">
                    <div class="panel panel-primary">
                        <a href="{{ route('admin.insuranceRenewal.list') }}?<?php echo appendDate(); ?>">
                            <div class="number">
                                <h3>
                                    <h3>{{ isset($totalInsuranceRenewal) ? $totalInsuranceRenewal : '' }}</h3>
                                    <small>{{ trans('messages.no_Insurance_renewel_request') }}</small>
                                </h3>
                            </div>
                            <div class="icon">
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-body form_fields">
                        ...
                        <a href="{{ Route('admin.report') }}" title="{{ trans('messages.reset') }}"
                            class="btn btn-sm border_btn"><em class='fa fa-refresh '></em> </a>
                            <a href="{{ route('admin.download-report') }}?<?php echo appendDate(); ?>" class="btn btn-primary">Download Insurance Renewals Report</a>
            ...
            <div class="col-xl-4 col-sm-12 col-xs-12 col-md-6">
                <div class="board">
                    <div class="panel panel-primary">
                            ...
                            <div class="number">
                                <h3>
                                    <h3>{{ isset($insuranceRenewed) ? $insuranceRenewed : '' }}</h3>
                                    <small>{{ trans('messages.no_Insurance_renewel_request') }}</small>
                                </h3>
                            </div>
                            <div class="icon">
