		...
		<div class="panel-body form_mobile">
			...
			<div class="form_row">
				...
				<div class="form-action ">
                    ...
                    <a href="{{url('admin/export/Gallery/xls')}}" class="btn btn-sm border_btn" title="Export Xls">Export Xls</a>
                    <a href="{{url('admin/export/Gallery/csv')}}" class="btn btn-sm border_btn" title="Export Csv">Export Csv</a>
