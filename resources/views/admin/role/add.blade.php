...
@section('content')
    ...
    <div class="header d-flex align-items-center">
        <h1 class="page-header">
            {{ trans('messages.role') }} {{ trans('messages.add') }}
        ...
        <ol class="breadcrumb ms-auto mb-0">
            ...
            <li><a href={{ route('admin.role.list') }}><em class="fa fa-users"></em>   {{ trans('messages.role') }} {{ trans('messages.list') }}
            </a></li>
        <li class="active">{{ trans('messages.addRole') }}</li>
        </ol>
    </div>
    ...
    <div id="page-inner">
        <div class="panel panel-default">
            <div class="panel-body">
                {{ html()->modelForm(null, 'POST')->route('admin.role.save')->attributes(['id' => 'roleForm', 'class' => 'form-horizontal', 'role' => 'form', 'autocomplete' => 'off'])->open() }}
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group third_party_select">
                            <label for="phone">{{trans('messages.permissionList')}} <span style="color:#5f8bc2;font-weight 600px;;"> ( {{ trans('messages.permissionHint') }}) </span></label>
                            @php $permissions_list = permissions_list(); @endphp
                            {{ html()->multiselect('permissions[]',$permissions_list,old('permissions')?old('permissions'):[])->attributes(['class' => 'form-control','multiple'=>'multiple','id'=>'mySelect']) }}
                        </div>
                    </div>
