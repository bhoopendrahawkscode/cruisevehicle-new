    ...
    <tbody>
        ...
        <tr>
            <td style="padding: 20px; font-size: 16px; line-height: 1.5;">
                <p style="margin: 0;">Dear {{ $renewal->user->full_name }},</p>
                <p style="margin: 15px 0;">This is a reminder that your vehicle fitness certificate  for {{ $renewal->reg_no}} is expiring in {{ $daysBefore }} days.</p>
