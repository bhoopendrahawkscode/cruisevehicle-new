...
class InsuranceCompanyController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->allowSubAdminRole = ['' => __(Constant::SELECT_ROLE)] + Role::where('slug', ['insurance_manager'])->pluck('name', 'id')->toArray();
        ...
        View::share([
            ...
            'statusPermission' => "INSURANCE_LIST",
            'version' => $version_
    ...
    public function list(Request $request)
    {
        ...
        $fieldsToSearch              =   array('status' => '=', 'id' => '!=', '*full_name-username-email*' => '*like-like-like*');
        ...
        extract($output);
        $statusChangeUrl        =    'admin/insurance-management/insurance-company/status/';
        return  View('admin.insuranceCompany.list', compact('result', 'searchVariable', 'sortBy', 'order', 'query_string', 'statusChangeUrl'));
    }
    ...
    public function add()
    {
        ...
        return  View('admin.insuranceCompany.add', compact('phonecode', 'sub_admin_roles','timeZone','password_generation'));
    }
    /**
     * Save Sub admin
     */
    public function save(Request $request)
    {
        ...
        $validate                   =   array(
            ...
            'insurance_company_employee_full_name'    => $this->requiredMin2Max60,
        ...
        if ($validator->fails()) {
            ...
            $obj->insurance_company_employee_full_name = $request->insurance_company_employee_full_name;
            ...
            $emailData = [
                ...
                'email' => $request->email, 'email_type' => 'insurance_company_password'
            ];
            ...
            return redirect()->route('admin.insuranceCompany.list')->with(constant::SUCCESS,trans("messages.insuranceCompanyAdded"));
        }
    }
    /**
     * Edit Sub admin
    ...
    public function edit($id)
    {
        ...
        $sub_admin_roles =  $this->allowSubAdminRole;
       $timeZone =collect($this->timeZoneList)->prepend(Constant::SELECT_TIMEZONE,'');
        return  View('admin.insuranceCompany.edit', compact('data', 'phonecode', 'id', 'sub_admin_roles','timeZone'));
    }
    /**
     * Update Sub admin
     */
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('admin.insuranceCompany.list')->with(constant::SUCCESS,trans("messages.insuranceCompanyUpdated"));
    }
