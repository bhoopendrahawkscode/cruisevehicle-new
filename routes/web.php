...
use App\Http\Controllers\Admin\FuelRefillController;
...
Route::get('/send-reminders', function () {
    Artisan::call('reminders:license-renewal');
    Artisan::call('reminders:fitness-expiry');
    Artisan::call('reminders:insurance-renewal');

    return '<h1>Reminders Cleared!</h1>';
});
...
Route::get('/site-up', function () {
	...
	Route::get('getPage', 'App\Http\Controllers\HomeController@getCms');
	...
	Route::middleware([AuthAdmin::class])->group(function () {
		...
		Route::middleware(Constant::GET_SECTION . Constant::SUB_ADMIN_MANAGEMENT)->group(function () {
			...
			Route::get('/sub-admin/status/{id}/{value}', [SubAdminController::class, 'status'])->middleware('App\Http\Middleware\CheckPermission:SUB_ADMIN_CHANGE_STATUS');
		...
		Route::get('/report', [ReportController::class, 'index'])->name('admin.report')->middleware('App\Http\Middleware\CheckPermission:REPORT_LIST');

		Route::get('/download-report', [ReportController::class, 'downloadInsuranceRenewalsReport'])->name('admin.download-report');
        ...
        Route::prefix('vehicle-management')->group(function () {
			Route::controller(BrandController::class)->prefix('brand')->group(function () {
				...
				Route::get('upload', 'upload')->name('admin.brand.upload')->middleware('App\Http\Middleware\CheckPermission:BRAND_ADD');
				Route::post('import', 'import')->name('admin.brand.import')->middleware('App\Http\Middleware\CheckPermission:BRAND_ADD');
			...
			Route::middleware(Constant::GET_SECTION . Constant::GALLERY_MANAGEMENT)->group(function () {
				Route::any('/gallery-list', [GalleryController::class, 'index'])->name('admin.gallery.index')->middleware('App\Http\Middleware\CheckPermission:GALLERY_MANGER_LIST');
				Route::get('/gallery-list/status/{id}/{value}', [GalleryController::class, 'status'])->middleware('App\Http\Middleware\CheckPermission:GALLERY_MANAGER_CHANGE_STATUS');
				Route::get('/gallery-list/delete/{id}', [GalleryController::class, 'delete'])->middleware('App\Http\Middleware\CheckPermission:GALLERY_MANAGER_DELETE');
				Route::get('/gallery-list/add', [GalleryController::class, 'add'])->name('admin.gallery.add')->middleware('App\Http\Middleware\CheckPermission:GALLERY_MANAGER_ADD');
				Route::post('/gallery-list/save', [GalleryController::class, 'save'])->name('admin.gallery.save')->middleware('App\Http\Middleware\CheckPermission:GALLERY_MANAGER_ADD');
				Route::get('/gallery-list/edit/{id}', [GalleryController::class, 'edit'])->name('admin.gallery.edit')->middleware('App\Http\Middleware\CheckPermission:GALLERY_MANAGER_EDIT');
				Route::post('/gallery-list/update/{id}', [GalleryController::class, 'update'])->name('admin.gallery.update')->middleware('App\Http\Middleware\CheckPermission:GALLERY__MANAGER_EDIT');
			});
		
			Route::middleware(Constant::GET_SECTION . Constant::BANNER_MANAGEMENT)->group(function () {
				Route::any('/banner-list', [BannerController::class, 'index'])->name('admin.banner.index')->middleware('App\Http\Middleware\CheckPermission:BANNER_MANGER_LIST');
				Route::get('/banner-list/status/{id}/{value}', [BannerController::class, 'status'])->middleware('App\Http\Middleware\CheckPermission:BANNER_MANAGER_CHANGE_STATUS');
				Route::get('/banner-list/delete/{id}', [BannerController::class, 'delete'])->middleware('App\Http\Middleware\CheckPermission:BANNER_MANAGER_DELETE');
				Route::get('/banner-list/add', [BannerController::class, 'add'])->name('admin.banner.add')->middleware('App\Http\Middleware\CheckPermission:BANNER_MANAGER_ADD');
				Route::post('/banner-list/save', [BannerController::class, 'save'])->name('admin.banner.save')->middleware('App\Http\Middleware\CheckPermission:BANNER_MANAGER_ADD');
				Route::get('/banner-list/edit/{id}', [BannerController::class, 'edit'])->name('admin.banner.edit')->middleware('App\Http\Middleware\CheckPermission:BANNER_MANAGER_EDIT');
				Route::post('/banner-list/update/{id}', [BannerController::class, 'update'])->name('admin.banner.update')->middleware('App\Http\Middleware\CheckPermission:BANNER_MANAGER_EDIT');
			});
			...
			Route::controller(FuelRefillController::class)->prefix('fuel-refill')->group(function () {
				Route::get('/', 'list')->name('admin.fuelrefill.list')->middleware('App\Http\Middleware\CheckPermission:FUEL_USED_LIST');
				Route::post('save', 'save')->name('admin.fuelrefill.save')->middleware('App\Http\Middleware\CheckPermission:FUEL_USED_ADD');
				Route::get('add', 'add')->name('admin.fuelrefill.add')->middleware('App\Http\Middleware\CheckPermission:FUEL_USED_ADD');
				Route::get('edit/{fuelrefill}', 'edit')->name('admin.fuelrefill.edit')->middleware('App\Http\Middleware\CheckPermission:FUEL_USED_EDIT');
				Route::post('update/{fuelrefill}', 'update')->name('admin.fuelrefill.update')->middleware('App\Http\Middleware\CheckPermission:FUEL_USED_EDIT');
				Route::get('delete/{fuelrefill}', 'delete')->name('admin.fuelrefill.delete')->middleware('App\Http\Middleware\CheckPermission:FUEL_USED_DELETE');
				Route::get('status/{fuelrefill}/{status}', 'status')->name('admin.fuelrefill.status')->middleware('App\Http\Middleware\CheckPermission:FUEL_USED_CHANGE_STATUS');
        ...
        Route::controller(ServiceProviderController::class)->prefix('service-provider')->group(function () {
            ...
            Route::get('delete/{serviceprovider}', 'delete')->name('admin.serviceprovider.delete')->middleware('App\Http\Middleware\CheckPermission:SERVICE_PROVIDER_DELETE');;
        ...
        Route::prefix('insurance-management')->group(function () {
            ...
            Route::controller(InsuranceCompanyController::class)->prefix('insurance-company')->group(function () {
				...
				Route::get('delete/{insuranceCompany}', 'delete')->name('admin.insuranceCompany.delete');
            ...
            Route::controller(InsuranceRenewalController::class)->prefix('insurance-renewal')->group(function () {
				...
				Route::get('view/{insuranceRenewal}','view')->name('admin.insuranceRenewal.view')->middleware('App\Http\Middleware\CheckPermission:INSURANCE_RENEWAL_LIST');
				Route::post('update/{insuranceRenewal}', 'update')->name('admin.insuranceRenewal.update');
				Route::post('submit-status-change', 'submit_status_change')->name('admin.insuranceRenewal.submit_status_change');
				Route::post('submit_certificate', 'submit_certificate')->name('admin.insuranceRenewal.submit_certificate');
			});
        });
