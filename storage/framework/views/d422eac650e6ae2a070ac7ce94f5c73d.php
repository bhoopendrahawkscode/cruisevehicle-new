                ...
                <div class="form_row">
                    <div class="form_fields d-flex mb-0 gap-2">
                        <div class="form-group mb-0">
                            <?php echo e(html()->text('name', isset($searchVariable['name']) ? $searchVariable['name'] : '')->attributes(['class' => 'form-control', 'placeholder' => trans('Search by Model Name')])); ?>
                    ...
                    <div class="form-action ">
                        ...
                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('MODEL_ADD'))) : ?>
                            <a href="<?php echo e(route('admin.model.add')); ?>" class="btn theme_btn bg_theme btn-sm py-2  btnIcon"
                        ...
                        <?php if(!$result->isEmpty()): ?>
                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e($record->brand ? $record->brand->name : ''); ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('MODEL_CHANGE_STATUS'))) : ?>
                                ...
                                <?php endif; ?>
                                    ...
                                    <td>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('MODEL_EDIT'))) : ?>
                                            <a title="<?php echo e(trans('Edit')); ?>" href="<?php echo e(route('admin.model.edit', $record->id)); ?>"
                                                class="btn btn-primary">
                                                <em class="fa fa-pencil"></em>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('MODEL_DELETE'))) : ?>
                                            <a class="btn btn-primary delete_any_item"
                                                data-id="<?php echo e(route('admin.model.delete', $record->id)); ?>"
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/model/index.blade.php ENDPATH**/ ?>