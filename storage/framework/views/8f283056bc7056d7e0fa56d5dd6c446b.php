			...
			<div class="form_row">
                <div class="form_fields d-flex mb-0 gap-2">
					<div class="form-group mb-0">
                        ...
                        'placeholder' => trans("messages.searchBy")." ".trans('Template title')])); ?>
					...
					<thead>
						<tr>
                            ...
                            <th scope="col" class="w-20p">
								...
								<?php getSortIcon($sortBy,$order,'subject') ?>
							</th>
							<th scope="col" class="w-20p">
								<?php echo e(link_to_route(
                                        $listRoute,
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/email_template/index.blade.php ENDPATH**/ ?>