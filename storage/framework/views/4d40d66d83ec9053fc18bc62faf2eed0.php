		...
		<div class="panel-body form_mobile">
			...
			<div class="form_row">
				...
				<div class="form-action ">
                    ...
                    <a href="<?php echo e(url('admin/export/Banner/xls')); ?>" class="btn btn-sm border_btn" title="Export Xls">Export Xls</a>
                    <a href="<?php echo e(url('admin/export/Banner/csv')); ?>" class="btn btn-sm border_btn" title="Export Csv">Export Csv</a>
				...
				<table class="<?php if(!$result->isEmpty()): ?> table table-striped table-hover <?php endif; ?>" id="sortable">
					...
					<thead>
						<tr>
							...
							<th scope="col" class="w-10p"><?php echo e(trans("messages.image")); ?></th>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<img class="border border-1" alt="" src="<?php echo e($record->thumbImage); ?>" width="50">
							</td>
                            <td class="breakAll">
							...
							<td class="breakAll">
							<?php if(!empty($record->banner_link)): ?>
								<a href="<?php echo e($record->banner_link); ?>" target="_blank" class="inline-block px-4 py-2 text-sm font-medium text-info bg-blue-600 rounded hover:bg-blue-700 transition-all duration-200">
									Click here
								</a>
							<?php else: ?>
                            ...
                            <td>
                                <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission($statusPermission))) : ?>
                                <?php if($record->getRawOriginal('status') == 1): ?>
							...
							<td>
								...
								<?php endif; ?>
								<?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission($deletePermission))) : ?>
                                <a class="btn btn-primary delete_any_item d-none" data-id="<?php echo e(URL::to('admin/'.$listUrl.'/delete/' . $record->id)); ?>" title="<?php echo e(trans('Delete')); ?>" href="javascript::void(0);">
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/banner/index.blade.php ENDPATH**/ ?>