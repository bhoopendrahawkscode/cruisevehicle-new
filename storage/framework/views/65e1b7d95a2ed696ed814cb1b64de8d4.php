            ...
            <div class="panel-body form_mobile">
                ...
                <div class="form_row">
                    ...
                    <div class="form-action ">
                        ...
                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('BRAND_ADD'))) : ?>
                            <a href="<?php echo e(route('admin.brand.add')); ?>" class="btn theme_btn bg_theme btn-sm py-2  btnIcon"
                                style="margin:0;" title="<?php echo e(trans('Add New')); ?>"> <em class='fa fa-add '></em></a>
                        <?php endif; ?>
                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('BRAND_ADD'))) : ?>
                            <a href="<?php echo e(route('admin.brand.upload')); ?>" class="btn theme_btn bg_theme btn-sm py-2 me-5"
                                style="margin:0 5px !important;" title="<?php echo e(trans('Bulk Upload')); ?>"> <em class='fa fa-upload '></em></a>
                        <?php endif; ?>
                        ...
                        <?php if(!$result->isEmpty()): ?>
                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php endif; ?>
                                    ...
                                    <td>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('BRAND_EDIT'))) : ?>
                                            <a title="<?php echo e(trans('Edit')); ?>" href="<?php echo e(route('admin.brand.edit', $record->id)); ?>"
                                                class="btn btn-primary">
                                                <em class="fa fa-pencil"></em>
                                            </a>
                                        <?php endif; ?>

                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('BRAND_DELETE'))) : ?>
                                        <a class="btn btn-primary delete_any_item" data-id="<?php echo e(route('admin.brand.delete',$record->id)); ?>"
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/brand/index.blade.php ENDPATH**/ ?>