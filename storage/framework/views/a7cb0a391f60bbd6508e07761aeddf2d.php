            ...
            <div class="form_row">
                <div class="form_fields d-flex mb-0 gap-2">
                    ...
                    <div class="form-group mb-0 w-20p">
                            <?php echo e(html()->select('insurance_status',['0' => 'Pending', '1' => 'Premium amount quoted', '2' => 'Rejected', '3' => 'Confirmed'],
                ...
                <table class="<?php if(!$result->isEmpty()): ?> table table-striped table-hover <?php endif; ?>">
                    ...
                    <thead>
                        <th scope="col">
                            ...
                            <?php getSortIcon($sortBy, $order, 'insurance_renewal_id') ?>
                        </th>
                        <th scope="col">
                            <?php echo e(link_to_route(
                                'admin.insuranceRenewal.list',
                        ...
                        <th scope="col">
                            ...
                            <?php getSortIcon($sortBy, $order, 'premium_payable') ?>
                        </th>
                        ...
                        <th scope="col">
                            ...
                            <?php getSortIcon($sortBy, $order, 'comment') ?>
                        </th>
                        ...
                        <th scope="col">
                            <?php echo e(trans('messages.insuranceRenewal.Status')); ?>
                    ...
                    <tbody>
                       ...
                       ?>
                        ...
                        <tr>
                            <td><?php echo e($value->insurance_renewal_id); ?></td>
                            <td><?php echo e($value->insuranceRenewal->full_name); ?></td>
                            <td><?php echo e($value->insuranceRenewal->nic); ?></td>
                            <td><?php echo e($value->insuranceRenewal->carModel->name ?? 'N/A'); ?></td>
                            <td><?php echo e($value->insuranceRenewal->year_of_manufacturer); ?></td>
                            <td><?php echo e($value->insuranceRenewal->vehicle_registration_mark); ?></td>
                            <td><?php echo e($value->insuranceRenewal->value?'INR. '.$value->insuranceRenewal->value:'N/A'); ?></td>
                            <td><?php echo e($value->insuranceRenewal->sum_to_be_insured?'INR. '.$value->insuranceRenewal->sum_to_be_insured:'N/A'); ?></td>
                            <td><?php echo e($value->insuranceRenewal->coverType->name ?? 'N/A'); ?></td>
                            <td><?php echo e($value->insuranceRenewal->periodInsuranceCover->name ?? 'N/A'); ?></td>
                            <td><?php echo e($value->premium_payable ? 'INR. ' . $value->premium_payable : 'N/A'); ?></td>
                            <td><?php echo e($value->comment ? $value->comment : 'N/A'); ?></td>
                            <td> <?php echo e(date(Config::get('constants.ADMIN_LISTING_DATE_FORMAT'), strtotime($value->created_at))); ?></td>
                            <td><?php
                                if($value->company_insurance_status == 0){ ?>
                                    <a class="btn btn-primary status_change" data-comment="<?php echo e($value->comment); ?>" data-premium_payable="<?php echo e($value->premium_payable); ?>" data-id="<?php echo e($value->company_insurance_renewal_id); ?>" href="javascript::void(0);">
                                        Pending
                                    </a>
                                <?php
                                ...
                                <?php
                                    ...
                                    <a class="btn btn-primary release_certificate" data-vehicle_id="<?php echo e($value->vehicle_id); ?>"  data-id="<?php echo e($value->company_insurance_renewal_id); ?>" href="javascript::void(0);">
                                        Release Certificate
                                    </a>
                                <?php
                                }else{
                            ...
                            <td><?php echo e(($value->company_insurance_status == 3) ? 'Active' : 'Inactive'); ?></td>
                            <td>
                        <a title="<?php echo e(trans('messages.view')); ?>"
                            href="<?php echo e(URL::to('admin/insurance-management/insurance-renewal/view/' . $value->insurance_renewal_id)); ?>"
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/insuranceRenewal/list_insurance_manager.blade.php ENDPATH**/ ?>