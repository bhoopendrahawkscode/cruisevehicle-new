                ...
                <div class="form_row">
                    <div class="form_fields d-flex mb-0 gap-2">
                        <div class="form-group mb-0">
                            <?php echo e(html()->text('capacity', isset($searchVariable['capacity']) ? $searchVariable['capacity'] : '')->attributes(['class' => 'form-control',
                            'placeholder' => trans('Engine capacity')])); ?>
                    ...
                    <div class="form-action ">
                        ...
                        <a href="<?php echo e(route($listRoute)); ?>" class="btn btn-sm border_btn btnIcon"
                            ...
                            <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('ENGINE_CAPACITY_ADD'))) : ?>
                            <a href="<?php echo e(route('admin.enginecapacity.add')); ?>" class="btn theme_btn bg_theme btn-sm py-2  btnIcon"
                                style="margin:0;" title="<?php echo e(trans('Add New')); ?>"> <em class='fa fa-add '></em></a>
                        <?php endif; ?>
                        ...
                        <thead>
                            ...
                            <th scope="col">
                                <?php echo e(link_to_route(
                                    $listRoute,
                                    trans('Engine capacity'),
                                    [
                                        'sortBy' => 'capacity',
                                        'order' => $sortBy == 'capacity' && $order == 'desc' ? 'asc' : 'desc',
                                    ],
                                    $query_string,
                                )); ?>

                                <?php getSortIcon($sortBy,$order,'capacity') ?>
                            </th>
                            <th scope="col">
                                <?php echo e(trans('Brand name')); ?>

                                   
                            </th>
                            <th scope="col">
                                <?php echo e(trans('Model name')); ?>
                        ...
                        <?php if(!$result->isEmpty()): ?>
                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e($record->capacity); ?>

                                    </td>
                                    <td>
                                    <?php echo e($record->brand ? $record->brand->name : 'N/A'); ?>

                                     
                                    </td>
                                    <td>
                                    <?php echo e($record->model ? $record->model->name : 'N/A'); ?>
                                    ...
                                    <td>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('ENGINE_CAPACITY_CHANGE_STATUS'))) : ?>
                                ...
                                <?php endif; ?>
                                    ...
                                    <td>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('ENGINE_CAPACITY_EDIT'))) : ?>
                                            <a title="<?php echo e(trans('Edit')); ?>" href="<?php echo e(route('admin.enginecapacity.edit',$record->id)); ?>" class="btn btn-primary">
                                                <em class="fa fa-pencil"></em>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('ENGINE_CAPACITY_DELETE'))) : ?>
                                            <a class="btn btn-primary delete_any_item" data-id="<?php echo e(route('admin.enginecapacity.delete',$record->id)); ?>"
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/enginecapacity/index.blade.php ENDPATH**/ ?>