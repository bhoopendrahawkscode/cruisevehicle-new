    ...
    <div id="page-inner">
        <div class="panel panel-default">
            <div class="panel-body">
                <?php echo e(html()->modelForm($model, 'POST')->route('admin.fueltype.update',$model)
            ->attributes(['id'=>'fueltypeForm','autocomplete' => 'off','enctype'=>'multipart/form-data'])->open()); ?>

              
              <?php echo $__env->make('admin.fueltype.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/fuelrefill/edit.blade.php ENDPATH**/ ?>