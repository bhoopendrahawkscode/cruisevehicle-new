    ...
    <tbody>
        <tr>
            <td style="padding: 20px; text-align: center;">
                <!-- Header -->
                <h1 style="margin: 0; font-size: 24px; color: #FFD700;">Fitness certificate  Expiry Reminder</h1>
            </td>
        </tr>
        <tr>
            <td style="padding: 20px; font-size: 16px; line-height: 1.5;">
                <p style="margin: 0;">Dear <?php echo e($renewal->user->full_name); ?>,</p>
                <p style="margin: 15px 0;">This is a reminder that your vehicle fitness certificate  for <?php echo e($renewal->reg_no); ?> is expiring in <?php echo e($daysBefore); ?> days.</p>
                <p style="margin: 15px 0;">Please make sure to renew your vehicle fitness certificate  on time to avoid any inconvenience.</p>
...
<?php /**PATH /var/www/html/resources/views/email/fitness_reminder.blade.php ENDPATH**/ ?>