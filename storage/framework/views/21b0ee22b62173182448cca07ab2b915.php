...
<div class="header d-flex align-items-center">
    <h1 class="page-header">
        <?php echo e(trans('messages.subAdmin')); ?> <?php echo e(trans('messages.list')); ?>

    </h1>
    <ol class="breadcrumb ms-auto mb-0">
        <li><a href="<?php echo e(Route('admin.dashboard')); ?>"><em class="fa fa-dashboard"></em> <?php echo e(trans('messages.dashboard')); ?> </a></li>
        <li class="active"><?php echo e(trans('messages.subAdmin')); ?> <?php echo e(trans("messages.list")); ?></li>
    </ol>
</div>
<div id="page-inner">
    <div class="panel panel-default">
		<div class="panel-body form_mobile">
             <?php echo e(html()->modelForm(null, 'GET')->route('admin.listSubadmin')
			...
			<div class="form_row">
				<div class="form_fields d-flex mb-0 gap-2">
					<div class="form-group mb-0">
                        ...
                        'placeholder' => trans('messages.subAdminSearchPlaceholder')])); ?>
				 ...
				 <div class="form-action ">
                    ...
                    <a href="<?php echo e(Route('admin.listSubadmin')); ?>" class="btn btn-sm border_btn btnIcon" title="<?php echo e(trans('messages.reset')); ?>"><em class='fa fa-refresh '></em> </a>
                    <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('SUB_ADMIN_ADD'))) : ?>
                    <a href="<?php echo e(Route('admin.Subadmin_add')); ?>" class="btn theme_btn bg_theme btn-sm py-2   btnIcon" style="margin:0;" title="<?php echo e(trans('Add New Sub-Admin')); ?>"> <em class='fa fa-add '></em></a>
                    <?php endif; ?>
                ...
                <table class="<?php if(!$result->isEmpty()): ?> table table-striped table-hover <?php endif; ?>">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('SUB_ADMIN_CHANGE_STATUS'))) : ?>
                            ...
                            <td>
                                ...
                                <a title="<?php echo e(trans('Edit')); ?>" href="<?php echo e(URL::to('admin/sub-admin-list/edit/' . $record->id)); ?>" class="btn btn-primary">
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/user/listSubadmin.blade.php ENDPATH**/ ?>