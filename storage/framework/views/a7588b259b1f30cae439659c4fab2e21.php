                ...
                <div class="form_row">
                    <div class="form_fields d-flex mb-0 gap-2">
                        <div class="form-group mb-0">
                            ...
                            'placeholder' => trans('Fuel Used Name')])); ?>
                        ...
                        <?php if(!$result->isEmpty()): ?>
                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('FUEL_USED_EDIT'))) : ?>
                                            <a title="<?php echo e(trans('Edit')); ?>" href="<?php echo e(route('admin.fueltype.edit',$record->id)); ?>" class="btn btn-primary">
                                                <em class="fa fa-pencil"></em>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('FUEL_USED_DELETE'))) : ?>
                                            <a class="btn btn-primary delete_any_item" data-id="<?php echo e(route('admin.fueltype.delete',$record->id)); ?>"
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/fueltype/index.blade.php ENDPATH**/ ?>