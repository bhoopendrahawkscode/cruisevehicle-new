    ...
    <tbody>
        <tr>
            <td style="padding: 20px; text-align: center;">
                <!-- Header -->
                <h1 style="margin: 0; font-size: 24px; color: #FFD700;">License Expiry Reminder</h1>
            </td>
        </tr>
        <tr>
            <td style="padding: 20px; font-size: 16px; line-height: 1.5;">
                <p style="margin: 0;">Dear <?php echo e($renewal->user->full_name); ?>,</p>
                <p style="margin: 15px 0;">This is a reminder that your License for <?php echo e($renewal->reg_no); ?> is expiring in <?php echo e($daysBefore); ?> days.</p>
                <p style="margin: 15px 0;">Please make sure to renew your License on time to avoid any inconvenience.</p>
                <p>Thank you,<br>Cruis Vehicle Managemen</p>
            </td>
        </tr>
        <!-- Footer -->
        <tr>
...
<?php /**PATH /var/www/html/resources/views/email/license_reminder.blade.php ENDPATH**/ ?>