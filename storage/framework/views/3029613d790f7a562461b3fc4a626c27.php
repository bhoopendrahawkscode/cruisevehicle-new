   ...
   // pr($result);die;
    ...
    <div class="header d-flex align-items-center">
        ...
        <ol class="breadcrumb ms-auto mb-0">
            ...
            <li class="active">Fuel Refill  <?php echo e(trans('messages.list')); ?></li>
        </ol>
    </div>
    <div id="page-inner">
                ...
                <div class="form_row">
                    ...
                    <div class="form-action ">
                        ...
                        <a href="<?php echo e(route($listRoute)); ?>" class="btn btn-sm border_btn btnIcon"
                            ...
                            <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('FUEL_USED_ADD'))) : ?>
                            <a href="<?php echo e(route('admin.fueltype.add')); ?>" class="btn theme_btn bg_theme btn-sm py-2  btnIcon"
                        ...
                        <thead>
                            ...
                            <th scope="col">
                                <?php echo e(link_to_route(
                                    ...
                                    [
                                        'sortBy' => 'vehicles.owner_name',
                                        'order' => $sortBy == 'vehicles.owner_name' && $order == 'desc' ? 'asc' : 'desc',
                                    ],
                                    $query_string,
                                )); ?>
                            ...
                            <th scope="col">
                                <?php echo e(link_to_route(
                                    ...
                                    [
                                        'sortBy' => 'cost',
                                        'order' => $sortBy == 'cost' && $order == 'desc' ? 'asc' : 'desc',
                                    ],
                                    $query_string,
                                )); ?>

                                <?php getSortIcon($sortBy,$order,'cost') ?>
                            </th>
                            <th scope="col">
                                <?php echo e(link_to_route(
                                    $listRoute,
                                    trans('Milease'),
                                    [
                                        'sortBy' => 'fuel_refill_mileage',
                                        'order' => $sortBy == 'fuel_refill_mileage' && $order == 'desc' ? 'asc' : 'desc',
                                    ],
                                    $query_string,
                                )); ?>
                        ...
                        <?php if(!$result->isEmpty()): ?>
                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                    <?php echo e($record['vehicle']['owner_name'] ?? ''); ?>


                                    </td>
                                    <td>
                                        <?php echo e($record->fuel_refill_cost); ?>

                                    </td>
                                    <td>
                                        <?php echo e($record->fuel_refill_mileage); ?>
                                    ...
                                    <td>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('FUEL_USED_CHANGE_STATUS'))) : ?>
                                    ...
                                    <td>
                                        <?php if (auth()->check() && (auth()->user()->role_id == 2 || auth()->user()->hasPermission('FUEL_USED_DELETE'))) : ?>
                                            <a class="btn btn-primary delete_any_item" data-id="<?php echo e(route('admin.fuelrefill.delete',$record->id)); ?>"
...
<?php echo $__env->make('admin.layouts.default_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/fuelrefill/index.blade.php ENDPATH**/ ?>